...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-29 20:03`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/aab0205f-6a6c-48db-bf19-a9123a152bd1.git
$ cd aab0205f-6a6c-48db-bf19-a9123a152bd1
```
